...
type GetVMByCidHandlerFunc func(GetVMByCidParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetVMByCidHandlerFunc) Handle(params GetVMByCidParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// GetVMByCidHandler interface for that can handle valid get Vm by cid params
type GetVMByCidHandler interface {
	Handle(GetVMByCidParams, interface{}) middleware.Responder
}
