...
// AddVMParams contains all the bound params for the add Vm operation
// typically these are obtained from a http.Request
//
// swagger:parameters addVm
...
func (o *AddVMParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
